...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function loadAllocatedData() {
    ...
    fetch(`/unallocated_data?fromDate=${fromDate}&toDate=${toDate}`)
      .then(response => response.json())
      .then(data => {
        const tableHead = document.querySelector("#unallocatedTable thead tr");
        ...
        adjustColumnWidths("#unallocatedTable");
      })
      .catch(error => {
        console.error("Error loading unallocated data:", error);
  ...
  function addRowClickSelection() {
    const tableBody = document.querySelector("#unallocatedTable tbody");
    ...
    //     const table = document.getElementById("unallocatedTable");
    ...
    document.getElementById("exportExcel").addEventListener("click", function () {
        ...
        const url = `/export-unallocated-data/?fromDate=${fromDate}&toDate=${toDate}`;
